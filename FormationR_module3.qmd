...
![](images/clipboard-2862186918.png)
...
# Package `ggplot2` ![](images/clipboard-4243774750.png){width="201"}
...
![](images/clipboard-3500636186.png)

![](images/clipboard-1136683792.png)
...
::: {.column width="60%"}
![](images/clipboard-3730255188.png)
:::
:::::
...
db = grstat_example() # generate a list of datasets
names(db)
...
```{r eval=FALSE, output = FALSE}
df_recist %>% 
  ggplot() # it will understand that the data is df_recist
```
...
functions often determine the form of the plot, while the other two can
still be specified later with others functions.
...
# figure boxplot
  ...
  scale_x_discrete(labels = c(`Complete response`="CR",
                              `Partial response` = "PR",
                              `Stable disease` = "SD",
...
::: {.column width="65%"}
![](images/clipboard-275570733.png)
:::
:::::
...
customization ranging from changing the location of the legends to
...
![](images/clipboard-369250986.png)

![](images/clipboard-1458169185.png)
