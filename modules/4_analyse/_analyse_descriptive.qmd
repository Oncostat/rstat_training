...
- Dans un module futur on verra `officer`, pour intégrer les crosstables dans des rapports automatisés <br> ![](media/chris-pratt.gif){fig-align="center" style="width:35%; margin-left:30%;"}
