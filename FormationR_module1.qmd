...
![](images/clipboard-4117190390%20-%20Copie.png)
...
::: {.column width="50%"}
![](images/clipboard-2231335957.png)
:::
:::::
...
-   comment or document your code by using `#` or `CTRL + SHIFT + C`
    ...
    -   `### Title3 ----` a title of level 3
        ...
        ![](images/clipboard-3422402088.png){width="413"}
...
![](images/clipboard-764478778.png)
...
::::: columns
::: {.column width="50%"}
![](images/clipboard-3201062396.png)
:::

::: {.column width="50%"}
![](images/clipboard-1281198536.png)
:::
:::::
...
::: {.column width="50%"}
![](images/clipboard-1302393951.png){width="479"}
:::
:::::::
...
![](images/clipboard-4083231145.png){width="224"}
...
![](images/clipboard-770258203.png){width="181"}
